package com.bgq.demo.restapi.ttsdemo;

import com.bgq.demo.restapi.common.ConnUtil;
import com.bgq.demo.restapi.common.DemoException;
import com.bgq.demo.restapi.common.TokenHolder;
...
public class TtsMain {
    ...
    public String getAudio() throws IOException, DemoException {
        return run();
    }

    private String text;
    //  填写网页上申请的appkey 如 $apiKey="g8eBUMSokVB1BHGmgxxxxxx"
    private final String appKey = "tKcW3REoRPiAmVnnwZjISrDG";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "QijYhNAreFkv8WlmdQ8w8u9tjOhd4LR2";
